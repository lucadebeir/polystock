...
<html lang="fr">
<head>
    <title>Modification d'un produit alimentaire</title>
...
<div>
    <h4 class="center-align">Modification d'un produit alimentaire</h4>

    <div class="container row z-depth-4 blue-grey lighten-5">

        <form class="col s12" method="post" action="/controller/Controller_Modif_Alim.php?idalim=<?php echo $idalim;?>&idstock=<?php echo $idstock;?>">
