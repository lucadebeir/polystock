...
<div>
    <h4 class="center-align">Modification d'un évènement</h4>

    <div class="container row z-depth-4 blue-grey lighten-5">

        <form class="col s12" method="post" action="/controller/Controller_Modif_Evenement.php?id=<?php echo $identifiant;?>">
            ...
            <div class="row">
                <div class="input-field col s9">
                    <input id="date" name="date" type="date" class="validate" value="<?php echo $date;?>" required>
                </div>
            </div>
